...
local MESSAGES = {
  ...
  D3080 = "The picture string must not contain more than one instance of the 'percent' character",
  D3081 = "The picture string must not contain more than one instance of the 'decimal-separator' character",
  D3082 = "The picture string must not contain more than one instance of the 'percent' character",
  D3083 = "The picture string must not contain more than one instance of the 'per-mille' character",
  D3084 = "The picture string must not contain both a 'percent' and a 'per-mille' character",
  D3085 = "The mantissa part of a picture string must contain at least one character that is either an 'optional digit character' or a member of the 'decimal digit family'",
  D3086 = "The picture string must not contain a passive character that is preceded by an active character and that is followed by another active character",
  D3087 = "The picture string must not contain a 'grouping-separator' character that appears adjacent to a 'decimal-separator' character",
  D3088 = "The picture string must not contain a 'grouping-separator' at the end of the integer part",
  D3089 = "The picture string must not contain two adjacent instances of the 'grouping-separator' character",
  D3090 = "The integer part of the picture string must not contain a member of the 'decimal digit family' that is followed by an instance of the 'optional digit character'",
  D3091 = "The fractional part of the picture string must not contain an instance of the 'optional digit character' that is followed by a member of the 'decimal digit family'",
  D3092 = "A sub-picture that contains a 'percent' or 'per-mille' character must not contain a character treated as an 'exponent-separator'",
  D3093 = "The exponent part of the picture string must comprise only of one or more characters that are members of the 'decimal digit family'",
